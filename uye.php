...
<body>
	...
	<div class="uyeol_tablo">
		...
		<form action="islem.php" method="post">
			...
			<button type="submit" class="btn btn-secondary btn-lg" name="kullanici_kaydet">Üye Ol</button>
			
		</form>

		<a href="index.php"><button type="submit" class="btn btn-primary">Geri Dön</button></a>
	</div>
